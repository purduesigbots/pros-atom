...
module.exports =
  class WelcomeView extends ScrollView
          ...
          @section class:"panel", =>
            ...
            @div outlet: 'versions', class: 'versions', =>
              @div () =>
                @div class: 'block', =>
                  @raw 'CLI: '
                  @span class: 'badge badge-flexible', outlet: 'cliVersion', => @span class: 'loading loading-spinner-tiny inline-block'
                @div class: 'block', =>
                  @raw 'Plugin: '
                  @span class: 'badge badge-flexible', outlet: 'pkgVersion', => @span class: 'loading loading-spinner-tiny inline-block'
          @footer class:"footer", =>
    ...
    initialize: ->
      ...
      @subscriptions.add atom.tooltips.add @gaInput, {title: 'We send anonymous analytics on startup of Atom.<br/>To disable, uncheck this box or disable telemetry within Atom'}
