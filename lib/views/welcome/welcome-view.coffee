  ...
  class WelcomeView extends ScrollView
    @content: ->
      @div class:"pros-welcome", =>
        @div class:"container", =>
          @header class:"header", =>
            @a class: 'hero', href: "pros.cs.purdue.edu", =>
          ...
          @footer class:"footer", =>
            @raw '<span id="cliVersion" class="text-subtle">Pros CLI Version: x</span>'
            @raw '<span id="pkgVersion" class="text-subtle">Pros for Atom Version: x</span><br/>'
